...
class PermissionSeeder {
  public async run() {
    ...
    await this.addPermission(
      'View establishment tokens',
      'view_establishment_tokens',
      'View establishment tokens',
    );
    await this.addPermission(
      'Create establishment token',
      'create_establishment_token',
      'Create establishment token',
    );
    await this.addPermission(
      'Edit establishment token',
      'edit_establishment_token',
      'Edit establishment token',
    );
    await this.addPermission(
      'Delete establishment token',
      'delete_establishment_token',
      'Delete establishment token',
    );
  ...
  public async addPermission(name, type, description) {
